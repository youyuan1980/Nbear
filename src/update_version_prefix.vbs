...
assemblies = array("NBear.Common", "NBear.Common.Design", "NBear.Data", "NBear.Test.UnitTests", "NBear.Test.CaseTests", "NBear.Tools.DbToEntityDesign", "NBear.IoC", "NBear.IoC.Hosts.ServiceHost", "NBear.IoC.Servers.ServiceMQServer", "NBear.Net", "NBear.Web", "NBear.Web.Data", "NBear.Tools.EntityDesignToEntity", "NBear.Tools.ConfigurationEncrypter", "NBear.Tools.EntityDesignToEntityVsPlugin","NBear.MVP")
